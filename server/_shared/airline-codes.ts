...
const GENERATED = new Map<string, { iata: string; name: string }>([
  ...
  ['AUB', { iata: 'OS', name: 'Austrian Airlines' }],
  ...
  ['IBK', { iata: 'NT', name: 'Iberia Express' }],
  ...
  ['WIF', { iata: 'W4', name: 'Wizz Air Abu Dhabi' }],
